...
const NewsSection = () => {
  ...
  // Tính toán số slide và cập nhật kích thước
  useEffect(() => {
    const updateSlideWidth = () => {
      if (containerRef.current) {
        const containerWidth = containerRef.current.offsetWidth;
        setSlideWidth(containerWidth / 2); // 2 slides visible
      }
    };
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 relative">
      ...
      {/* Carousel container */}
      <div 
        className="container mx-auto max-w-6xl overflow-hidden relative"
        ref={containerRef}
      >
        <div 
