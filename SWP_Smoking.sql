...
CREATE DATABASE [SWP_Smoking_02]
USE [SWP_Smoking_02]
GO
/****** Object:  Table [dbo].[ACHIEVEMENT]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[APPOINTMENT]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[BLOG_POST]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DAILY_TRACKING]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FEEDBACK]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NOTIFICATION]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[QUITTING_PLAN]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SPECIALIST]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SUBSCRIPTION_PLAN]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_ACHIEVEMENT]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_SUBSCRIPTION]    Script Date: 20/05/2025 2:29:55 CH ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__USER__AB6E616410352AE8]    Script Date: 20/05/2025 2:29:55 CH ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__USER__F3DBC572D8822D1C]    Script Date: 20/05/2025 2:29:55 CH ******/
ALTER TABLE [dbo].[USER] ADD UNIQUE NONCLUSTERED 
(
	[username] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
REFERENCES [dbo].[USER] ([user_id])
GO
ALTER TABLE [dbo].[BLOG_POST]  WITH CHECK ADD  CONSTRAINT [FK_BLOGPOST_USER] FOREIGN KEY([user_id])
REFERENCES [dbo].[USER] ([user_id])
GO
ALTER TABLE [dbo].[BLOG_POST] CHECK CONSTRAINT [FK_BLOGPOST_USER]
GO
